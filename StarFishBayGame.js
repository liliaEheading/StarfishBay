...
if (reversed == null) { reversed = false; }
	...
	this.text_17.setTransform(604.7,199.2208,0.9468,0.9468);
	...
	this.timeline.addTween(cjs.Tween.get(this.text_18).wait(3).to({_off:false},0).wait(13).to({y:26.2,text:" Intertidal Sandy Shore – Middle Shore"},0).wait(18).to({x:483.45,y:25.8,text:" Intertidal Sandy Shore – Lower Shore"},0).wait(17).to({x:487.95,y:20.7,text:"Mangrove Ecosystem",font:"bold 18px 'Nirmala UI'",lineHeight:25.9},0).wait(13).to({y:22.7,text:"Subtidal Zone"},0).to({_off:true},14).wait(41).to({_off:false,y:22,text:"Reference",font:"18px 'Nirmala UI'",color:"#000000"},0).to({_off:true},8).wait(72));
	...
	this.instance_22.setTransform(621.5,234.05,0.7615,0.8126,0,0,0,195.8,159.3);
	...
	this.instance_27.setTransform(450.85,432.8,0.4047,0.4047,0,0,0,-3.1,-1);
